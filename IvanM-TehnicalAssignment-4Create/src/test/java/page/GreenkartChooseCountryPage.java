...
public class GreenkartChooseCountryPage extends BaseTest {
    ...
    public  void clickActionsBtn(){
        actionsTitle.click();
    }

    public void goBackWDHomePage() throws IOException {
    ...
    public boolean verifyActionsInTheHeader() {
        /*wdWait.until(ExpectedConditions.visibilityOf(mainHeader));
        String bodyText = mainHeader.getText();
        Assert.assertTrue("Action", bodyText.contains("Action"));
        System.out.println("Header contains Action");*/
        wdWait.until(ExpectedConditions.visibilityOf(mainHeader));
        String bodyText = mainHeader.getText();
